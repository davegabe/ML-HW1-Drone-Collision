...
For further analysis, the confusion matrix of the 4 classifiers is shown in Figure~\ref{fig:confusion_matrix} and the accuracy is shown in Table~\ref{tab:results-classification}.
\begin{figure}[h]
    \centering
    \begin{tabular}{cc}
